# Мед Портал — Лента (прототип)

Интерактивный прототип раздела «Лента» для Мед Портала — профессиональной ленты для врачей, встроенной в существующий shell продукта. Две адаптации из одной модели данных: **Desktop web** и **iPhone 15 Pro Max**.
